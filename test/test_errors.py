...
class TestWhitePlacementErrors(unittest.TestCase):
    ...
    def test_no_queen_turn_4(self):
        ...
        game_board.perform_action_helper(game_board.PLACE_PIECE, (0, 2), piece_type=spaces.Piece.BEETLE)
        game_board.perform_action_helper(game_board.PLACE_PIECE, (0, -2), piece_type=spaces.Piece.ANT)
        game_board.perform_action_helper(game_board.PLACE_PIECE, (0, 3), piece_type=spaces.Piece.BEETLE)
...
class TestBlackPlacementErrors(unittest.TestCase):
    ...
    def test_no_queen_turn_4(self):
        ...
        game_board.perform_action_helper(game_board.PLACE_PIECE, (0, -2), piece_type=spaces.Piece.ANT)
        game_board.perform_action_helper(game_board.PLACE_PIECE, (0, 3), piece_type=spaces.Piece.BEETLE)
        game_board.perform_action_helper(game_board.PLACE_PIECE, (0, -3), piece_type=spaces.Piece.ANT)
        self.assertRaisesRegex(
            RuntimeError,
            'Illegal action. You must place your Queen Bee by your fourth turn.',
            game_board.perform_action_helper,
