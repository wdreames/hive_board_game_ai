...
class TestSampleGameWithNoMovement(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_white_pieces_to_place = copy.deepcopy(cls.game_board.white_pieces_to_place)
        cls.expected_black_pieces_to_place = copy.deepcopy(cls.game_board.black_pieces_to_place)

    def test_a_players_have_same_pieces(self):
        self.assertEqual(self.game_board.white_pieces_to_place, self.game_board.black_pieces_to_place)

    def test_b_all_moves_first_two_turns(self):
        # Check that white has all moves available
        expected_available_moves = {(0, 0)}
        _, actual_available_moves = self.game_board.get_all_possible_placements()
        self.assertEqual(expected_available_moves, actual_available_moves)

        self.game_board.place_piece('Ant', (0, 0))  # White
        ...
        self.game_board.place_piece('Grasshopper', (-1, -1))  # Black

    def test_c_limited_set_of_moves(self):
        # Ensure move lists are limited past turn 2
        expected_white_available_moves = {(0, 1), (1, 1), (1, 0)}
        _, actual_white_available_moves = self.game_board.get_all_possible_placements()
        self.assertEqual(expected_white_available_moves, actual_white_available_moves)

        self.game_board.place_piece('Queen Bee', (0, 1))  # White
        expected_black_available_moves = {(-2, -1), (-2, -2), (-1, -2)}
        _, actual_black_available_moves = self.game_board.get_all_possible_placements()
    ...
    def test_d_correct_number_of_turns(self):
        ...
        self.game_board.place_piece('Ant', (-1, -2))  # Black
        self.game_board.place_piece('Ant', (1, 2))  # White
        self.game_board.place_piece('Ant', (-2, -3))  # Black

        # Each player has made 3 moves; Should be turn 7 now
        expected_turn_number = 7
        actual_turn_number = self.game_board.turn_number
    ...
    def test_e_correct_num_pieces(self):
        ...
        actual_white_pieces_to_place = self.game_board.white_pieces_to_place
        actual_black_pieces_to_place = self.game_board.black_pieces_to_place
    ...
    def test_f_correct_locations(self):
        ...
        actual_piece_locations = self.game_board.pieces.keys()
        ...
        actual_emt_spc_locations = self.game_board.empty_spaces.keys()
    ...
    def test_g_correct_avail_moves(self):
        ...
        actual_white_pieces_to_place, actual_white_available_moves = self.game_board.get_all_possible_placements()
        self.assertEqual(self.expected_white_pieces_to_place, actual_white_pieces_to_place)
        self.assertEqual(expected_white_available_moves, actual_white_available_moves)

        # Make a move for white
        self.game_board.place_piece('Grasshopper', (2, 2))  # White
        ...
        actual_black_pieces_to_place, actual_black_available_moves = self.game_board.get_all_possible_placements()
    ...
    def test_h_no_winner_yet(self):
        ...
        actual_winner = self.game_board.determine_winner()
        self.assertEqual(expected_winner, actual_winner)

    def test_i_end_game_correct_num_turns(self):
        # Continue making moves
        self.game_board.place_piece('Queen Bee', (-2, -2))  # Black
        self.game_board.print_board()
        print(self.game_board)
        self.game_board.place_piece('Ant', (1, 1))  # White
        self.game_board.place_piece('Grasshopper', (-3, -3))  # Black
        self.game_board.place_piece('Grasshopper', (2, 1))  # White
        self.game_board.place_piece('Grasshopper', (-3, -2))  # Black
        self.game_board.place_piece('Grasshopper', (3, 2))  # White
        self.game_board.place_piece('Ant', (-2, -1))  # Black
    ...
    def test_j_correct_piece_connections(self):
        ...
        actual_piece_connections = self.game_board.pieces[(0, 0)].connected_pieces
        actual_emt_spc_connections = self.game_board.pieces[(0, 0)].connected_empty_spaces
    ...
    def test_k_correct_emt_spc_connections(self):
        ...
        actual_piece_connections = self.game_board.empty_spaces[(1, 0)].connected_pieces
        actual_emt_spc_connections = self.game_board.empty_spaces[(1, 0)].connected_empty_spaces
        self.assertEqual(expected_piece_connections, actual_piece_connections)
        self.assertEqual(expected_emt_spc_connections, actual_emt_spc_connections)
